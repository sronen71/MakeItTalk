...
```
#(old version) sudo apt-get install ffmpeg
Better: install form here: https://github.com/FFmpeg/FFmpeg

Wine:

Install using these instructions:
https://wine.htmlvalidator.com/install-wine-on-ubuntu-16.04.html
